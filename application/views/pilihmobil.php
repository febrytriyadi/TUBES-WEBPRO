            ...
            <div class="row" style="margin-top: 50px">
                    ...
                    <div class="form-group col-sm-9">
                        <div class="container">
                            ...
                            <center>
                            <div class="row">
                                <div class="col-md-7" style="margin-left: 50px ;margin-top: 10px; background-color: white; border-radius: 5px">
                                    
                                    <div class="col-md-4">

                                        <!--untuk menampilkan pilihan data mobil -->
                                    ...
                                    <div class="col-md-5" style="padding-top: 10px">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>12 jam</td>
                                                <td></td>
                                                <td style="color: orange">Rp. <?php $pajak=$key->harga*0.1; $harga=$key->harga/2+$pajak;
                                    ...
                                    <div class="col-md-3" style="padding-top: 50px; padding-bottom: 10px">
                                        <button type="button" class="btn btn-block" data-toggle="modal" data-target="#order<?php echo $key->id_mobil; ?>" style="background-color: orange;color: white;">Order</button>
                            ...
                            <div id="order<?php echo $key->id_mobil; ?>" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="<?php echo base_url(); ?>C_transaksi/proses_pesanan">
                                                <input type="hidden" name="id_mobil" value=<?php echo "'".$key->id_mobil."'"; ?>>
                                                <input type="hidden" name="proses" value="On proses">
                                                <input type="hidden" name="id_kendaraan" value="<?php echo $key->id_mobil; ?>">
